...
// ID 500 wird im Code bercksichtigt ! { 0    1    2    3    4    5    6    7    8 };
 ...
 *³ Aufgaben  : - Ressource-ID fr Animouse Resource DLL ermitteln         ³
 *³ Rckgabe  : Base Resource Id                                           ³
 ...
 *³ Kommentar : l„dt Pointer-Resource direkt aus Animouse DLL              ³
 *³ Autor     : C.Langanke                                                 ³
 *³ Datum     : 23.07.1995                                                 ³
 *³ Žnderung  : 23.07.1995                                                 ³
 *³ aufgerufen: diverse                                                    ³
...
GetAnimousePointerResource( HMODULE hmodResource, ULONG ulResourceId, PICONINFO piconinfo )
{
  ...
  do
  {
    ...
    // Daten direkt aus DLL lesen, damit das System nicht die DLL festh„lt
 ...
 *³ Kommentar : l„dt Pointer aus Animouse DLL                              ³
 *³ Autor     : C.Langanke                                                 ³
 *³ Datum     : 23.07.1995                                                 ³
 *³ Žnderung  : 23.07.1995                                                 ³
 *³ aufgerufen: diverse                                                    ³
 ...
 *³ Kommentar : l„dt ersten Pointer aus Animouse DLL                       ³
 *³ Autor     : C.Langanke                                                 ³
 *³ Datum     : 23.07.1995                                                 ³
 *³ Žnderung  : 23.07.1995                                                 ³
 *³ aufgerufen: diverse                                                    ³
...
WriteAnimouseDllFile( PSZ pszAnimationFileName, BOOL fSaveAll, PPOINTERLIST papl, PSZ pszInfoName, PSZ pszInfoArtist )
{
  ...
  do
  {
    ...
    *pbData = 0;
    ...
    // Gr”áe der Pages des Original berechnen
